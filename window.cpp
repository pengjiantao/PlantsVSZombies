    ...
    ui(new Ui::window)
{
    ...
    this->ui->groupBox->setStyleSheet("background-color: red");
    this->ui->groupBox_2->setStyleSheet("background-color: red");
    this->ui->groupBox_3->setStyleSheet("background-color: red");
    this->ui->groupBox_4->setStyleSheet("background-color: red");
    this->ui->groupBox_5->setStyleSheet("background-color: red");
    this->ui->groupBox_6->setStyleSheet("background-color: red");
    this->ui->groupBox_7->setStyleSheet("background-color: red");
    this->ui->groupBox_8->setStyleSheet("background-color: red");
    this->ui->groupBox_9->setStyleSheet("background-color: red");
    this->ui->groupBox_10->setStyleSheet("background-color: red");
